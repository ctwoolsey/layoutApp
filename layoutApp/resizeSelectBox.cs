...
namespace layoutApp
{
    public class resizeSelectBox
    {
        ...
        public resizeSelectBox(Object containerItem, boxTypes boxType, Color boxColor)
        {
        ...
        public Boolean contains(Point mouseLocation)
        {
            return (bounding.Contains(mouseLocation));
        }
